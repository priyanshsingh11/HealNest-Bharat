...
import { LoginForm, type CaretakerOption } from "@/components/login-form";
...
const PROFESSION_ORDER: CategoryId[] = ["doctor", "nurse", "babysitter", "caregiver", "physiotherapist", "phlebotomist"];
...
export default async function LoginPage({ searchParams }: PageProps) {
  ...
  const [providers, categories, customer] = await Promise.all([
    repo.listProviders(),
    repo.listCategories(),
    repo.getUser(DEMO_USER_ID),
  ]);
